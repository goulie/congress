...
@if ($edit ?? false)
    <form class="ajax-form" method="POST" action="{{ route('sponsor.update.group') }}" enctype="multipart/form-data">
        <input type="hidden" name="uuid" value="{{ $sponsor->uuid ?? '' }}">
    @else
        <form class="ajax-form" method="POST" action="{{ route('sponsors.store.group') }}" enctype="multipart/form-data">
@endif
@csrf
...
<div class="box-body">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input type="email" class="form-control" name="email" value="{{ $sponsor->email ?? '' }}" required>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="tel" class="form-control" name="phone" value="{{ $sponsor->phone ?? '' }}" required>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="url" class="form-control" name="website" value="{{ $sponsor->website ?? '' }}">
        </div>
        ...
        <div class="col-md-6">
            ...
            @if (isset($sponsor) && $sponsor->logo)
                <div class="mt-2">
                    <img src="{{ Voyager::image($sponsor->logo) }}" alt="Logo" style="max-height: 80px;">
                </div>
            @endif
        </div>
