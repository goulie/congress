...
<!-- ONGLET EXPOSANTS -->
@if ($edit ?? false)
    <form class="ajax-form" method="POST" action="{{ route('exhibitor.update.group') }}" enctype="multipart/form-data">
...
<div class="box-body">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="company_name" value="{{ $exhibitor->company_name ?? '' }}"
                required>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" name="additional_badges" min="0" max="10"
                value="{{ $exhibitor->additional_badges ?? 0 }}" data-price="50">
